...
```bash
#组合进行加密和解密
tar -czvf - a.cpp | openssl des3 -salt -k '密码' -out  file.tar.gz 

openssl des3 -d -k '密码' -salt -in  file.tar.gz  | tar xzvf - 
```
