...
$crontab  -e     #使用这个命令来进行设定, 执行后会进入VI 编辑模式.添加如下内容.
 ...
 03  10  *   *  0  mail -s "at 12:00" dmtsai < /home/dmtsai/.bashrc  #每周日10点3分执行
 02  5   3   *  *  mail -s "at 12:00" dmtsai < /home/dmtsai/.bashrc  #每月3日5点20分执行
 02  5   *   1  *  mail -s "at 12:00" dmtsai < /home/dmtsai/.bashrc  #每年1月5点20分执行
#分  时  日  月  周  <指令段>
...
02 0 * * 0   root  /bin/sh /root/a.sh    #每周日的0点 2分用身份root 执行一次指令
02 0 * * 7   root  /bin/sh /root/a.sh    #每周日的0点 2分用身份root 执行一次指令
```
